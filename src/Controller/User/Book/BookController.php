...
final class BookController extends AbstractController
{
    ...
    #[Route('/livres-disponibles', name: 'app_book_list_non_emprunter', methods: ['GET'])]
    public function livresDisponibles(EntityManagerInterface $entityManager): Response
    {
        $qb = $entityManager->createQueryBuilder();
